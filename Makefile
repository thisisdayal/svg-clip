...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=svg_clip -l --tb=short --maxfail=1 tests/
...
virtualenv:       ## Create a virtual environment.
	...
	@rm -rf .venv
	@if [ "$(VIRTUALENV)" ]; then virtualenv .venv; else python3 -m venv .venv; fi
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "svg_clip = 'svg_clip.__main__:main'" >> pyproject.toml
